...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../styles/judge_style.css">
...
<form action="" method="POST" enctype="multipart/form-data" onsubmit="return registrationValidation()" style="padding:20px;">
  <table>
      <tr>
          ...
          <td align="center">
              <div class="card border-success mb3 dropshadow">
                  <div class="card-header text-success">Register as Judge</div>
                  <div class="card-body">
    <table>
        <tr>
    ...
    <script src="../scripts/judge_validation.js"></script>
